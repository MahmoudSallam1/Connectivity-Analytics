...
org_place_aggregated = connectivity_ratio_ordered(
    df, ["organisation_name", "place_name"]
)
...
def plolty_go_bar(df, x, title):
    ...
    fig = go.Figure()
    fig.add_trace(go.Bar(x=x, y=y, name="Connected", marker_color="#5F9EA0"))
    fig.add_trace(go.Bar(x=x, y=z, name="Disconnected", marker_color="#CD5C5C"))
...
bar_titles = [
    ...
    "Assests Connectivity",
    "WeekDays Connectivity",
]
...
app.layout = html.Div(
    ...
    children=[
        ...
        html.P(
            children="Connectivity Data Analytics.",
            style={"textAlign": "center", "fontFamily": "Roboto", "color": "#444",},
        ),
        html.Div(
            children=[
                html.Div(
        ...
        html.Div(style={"width": "60%", "height": "4px", "backgroundColor": "#aaaa"}),
        html.Div(
            children=[
                html.Div(
        ...
        html.Div(style={"width": "60%", "height": "4px", "backgroundColor": "#aaaa"}),
        html.Div(dcc.Graph(id=figs[2].layout.title.text, figure=figs[2])),
    ],
)
